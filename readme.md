...
1. Run the python script (this make take while depending on the number of activities (.fit files). For the script to work you will need to have the python fitparse library, available [here](http://dtcooper.github.io/python-fitparse/ "Fit Parse Library").
